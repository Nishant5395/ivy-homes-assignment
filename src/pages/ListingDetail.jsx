...
//       .then((data) => {
//         if (!cancelled) setSimilar(data.results || data || []);
//       })
...
//   return (
//     <div>
//       <Link to="/" className="text-sm text-slate hover:text-ink">&larr; Back to listings</Link>
...
//         {!listing.is_live && <span className="ml-2 text-red-700">(Inactive)</span>}
//       </p>

//       <p className="text-gold text-3xl font-medium mb-6">{formatPrice(listing.price)}</p>

//       <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 text-sm">
//         <div>
//           <p className="text-muted">Carpet area</p>
//           <p className="text-ink font-medium">{listing.carpet_area} sqft</p>
//         </div>
//         <div>
//           <p className="text-muted">Super built-up</p>
//           <p className="text-ink font-medium">{listing.super_built_up_area} sqft</p>
//         </div>
//         <div>
//           <p className="text-muted">Floor</p>
//           <p className="text-ink font-medium">{listing.floor} / {listing.total_floors}</p>
//         </div>
//         <div>
//           <p className="text-muted">Facing</p>
//           <p className="text-ink font-medium capitalize">{listing.facing_direction}</p>
//         </div>
//         <div>
//           <p className="text-muted">Bathrooms</p>
//           <p className="text-ink font-medium">{listing.bathroom}</p>
//         </div>
//         <div>
//           <p className="text-muted">Balcony</p>
//           <p className="text-ink font-medium">{listing.balcony}</p>
//         </div>
//         <div>
//           <p className="text-muted">Covered parking</p>
//           <p className="text-ink font-medium">{listing.covered_parking}</p>
//         </div>
//         <div>
//           <p className="text-muted">Verified</p>
//           <p className="text-ink font-medium">{listing.is_verified ? 'Yes' : 'No'}</p>
//         </div>
//       </div>
...
//         <h2 className="text-muted mb-2">Posted by</h2>
//         <p className="text-ink">{listing.posted_by_name} ({listing.posted_by}) · {listing.posted_by_contact}</p>
//       </div>

//       {similar.length > 0 && (
//         <div>
//           <h2 className="font-serif text-xl text-ink mb-3">You may also like</h2>
//           <div className="grid sm:grid-cols-2 gap-3">
//             {similar.slice(0, 4).map((s) => (
//               <Link
//                 key={s.listing_id}
//                 to={`/listings/${s.listing_id}`}
//                 className="border border-gray-200 rounded p-3 hover:border-slate transition-colors"
//               >
//                 <p className="text-ink font-medium truncate">{s.apartment_name}</p>
//                 <p className="text-sm text-muted">{s.locality} · {s.bedroom} BHK</p>
//                 <p className="text-gold">{formatPrice(s.price)}</p>
//               </Link>
//             ))}
//           </div>
//         </div>
